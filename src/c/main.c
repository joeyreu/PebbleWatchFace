...
static void battery_update_proc(Layer *layer, GContext *ctx) {
  ...
  int width = (s_battery_level * 87) / 100;
...
static void main_window_load(Window *window) {
  ...
  s_time_layer = text_layer_create(
      GRect(15, PBL_IF_ROUND_ELSE(58, 30), bounds.size.w-25, 50));
  ...
  s_weather_layer = text_layer_create(
      GRect(0, PBL_IF_ROUND_ELSE(125, 146), bounds.size.w, 25));
  ...
  s_battery_layer = layer_create(GRect(20, 90, 87, 2));
